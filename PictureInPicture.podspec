#
#  Be sure to run `pod spec lint PictureInPicture.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Karanbir Singh" => "karanbir.singh@dropitapp.com" }
  # Or just: s.author    = "Karanbir Singh"
  # s.authors            = { "Karanbir Singh" => "karanbir.singh@abspl.in" }
  # s.social_media_url   = "http://twitter.com/Karanbir Singh"
